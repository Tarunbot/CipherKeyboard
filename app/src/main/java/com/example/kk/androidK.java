...
public class androidK extends InputMethodService implements KeyboardView.OnKeyboardActionListener {
    ...
    static int communicate=0;
    public static String password="#group5";

    static EditText type_ll;
    private static final String ALGORITHM = "AES";
    private static  int KEY = (int) (Math.random()*10000);

    private static String defaes="MYSUPERWORDKEY";
    private static String aeskey="";
    private static String KEYL=defaes;
                ...
                if(global.toString().equals("#affine")){
                   ...
                   enable=0;
                    ...
                    if(mode==1){
                        ...
                        Toast.makeText(this,"Affine Time :"+(double)(endtime1-starttime1)/(double)1000000,Toast.LENGTH_LONG).show();
                    }else {
                        ...
                        try {
                            ...
                            sb = encryptAES(temp1);
                            long endtime1 = System.nanoTime();
                            Toast.makeText(this,"AES Time :"+(double)(endtime1-starttime1)/(double)1000000,Toast.LENGTH_LONG).show();
                        } catch (Exception e) {
...
//                Log.e("clipboard", "onKey: \n"+clipboard.getText().toString(),null );
            ...
            default:
                ...
                if(Character.isLetter(code) && isCaps){
                    ...
                    if(global.toString().equals("#affine") && validpassword==1){
                    ...
                    }else if(global.toString().equals("#send")){
                        ...
                        try {
                            ...
                            Toast.makeText(this," KEY SHARED "+ss,Toast.LENGTH_SHORT).show();
                            throw new RuntimeException(e);
                        }

                        inputConnection.commitText(""+ss, 0);

                    }else if(enable==1 && global.toString().equals("#recieve")){
                        int A = (int)Math.pow(g, a) % p;
                        ClipboardManager clipboard = (ClipboardManager) getSystemService(CLIPBOARD_SERVICE);
                        String cat="";
                        try {
                            cat=decryptAES(clipboard.toString());
                        } catch (Exception e) {
                            throw new RuntimeException(e);
                        }
                        int conve=Integer.parseInt(cat);
                        int s = (int)Math.pow(conve, a)%p;
                        if(communicate==0){
                            communicate=1;
                            KEYL=""+s;
                        }
                        Toast.makeText(this," KEY RECIEVED ",Toast.LENGTH_SHORT).show();
                    }else if(enable==1 && global.toString().equals("#close")){
                        communicate=0;
                        KEYL=defaes;
                        Toast.makeText(this," KEY DEFAULT ",Toast.LENGTH_SHORT).show();
    ...
    public static String encryptAES(String plaintext) throws Exception {
        SecretKeySpec key = new SecretKeySpec(KEYL.getBytes(), ALGORITHM);
